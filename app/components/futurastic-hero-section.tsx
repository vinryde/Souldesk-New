...
export const AuroraHero = () => {
  ...
  return (
    <motion.section
      ...
      className="relative grid min-h-[100vh] place-content-center overflow-hidden bg-white px-4 py-24 text-gray-200"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20 overflow-hidden leading-none">
        <svg
